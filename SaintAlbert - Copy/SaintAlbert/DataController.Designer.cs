...
namespace SaintAlbert
{
    partial class DataController
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.daLogin = new System.Data.OleDb.OleDbDataAdapter();
    ...
    "Y WardID";
            ...
            // 
            this.oleDbSelectCommand11.CommandText = "SELECT        LOGIN.*\r\nFROM            LOGIN\r\nORDER BY LoginID";
            this.oleDbSelectCommand11.Connection = this.ctnSaintAlbert;
            // 
            // oleDbInsertCommand11
            // 
            this.oleDbInsertCommand11.CommandText = "INSERT INTO `LOGIN` (`Username`, `Password`, `User`) VALUES (?, ?, ?)";
            this.oleDbInsertCommand11.Connection = this.ctnSaintAlbert;
            ...
            new System.Data.OleDb.OleDbParameter("User", System.Data.OleDb.OleDbType.VarWChar, 0, "User")});
            // 
            // oleDbUpdateCommand11
            // 
            this.oleDbUpdateCommand11.CommandText = resources.GetString("oleDbUpdateCommand11.CommandText");
            this.oleDbUpdateCommand11.Connection = this.ctnSaintAlbert;
            this.oleDbUpdateCommand11.Parameters.AddRange(new System.Data.OleDb.OleDbParameter[] {
            new System.Data.OleDb.OleDbParameter("Username", System.Data.OleDb.OleDbType.VarWChar, 0, "Username"),
            new System.Data.OleDb.OleDbParameter("Password", System.Data.OleDb.OleDbType.VarWChar, 0, "Password"),
            new System.Data.OleDb.OleDbParameter("User", System.Data.OleDb.OleDbType.VarWChar, 0, "User"),
            new System.Data.OleDb.OleDbParameter("Original_LoginID", System.Data.OleDb.OleDbType.Integer, 0, System.Data.ParameterDirection.Input, false, ((byte)(0)), ((byte)(0)), "LoginID", System.Data.DataRowVersion.Original, null),
            ...
            new System.Data.OleDb.OleDbParameter("IsNull_User", System.Data.OleDb.OleDbType.Integer, 0, System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "User", System.Data.DataRowVersion.Original, true, null),
            new System.Data.OleDb.OleDbParameter("Original_User", System.Data.OleDb.OleDbType.VarWChar, 0, System.Data.ParameterDirection.Input, false, ((byte)(0)), ((byte)(0)), "User", System.Data.DataRowVersion.Original, null)});
            // 
            // oleDbDeleteCommand11
            // 
            this.oleDbDeleteCommand11.CommandText = resources.GetString("oleDbDeleteCommand11.CommandText");
            this.oleDbDeleteCommand11.Connection = this.ctnSaintAlbert;
            ...
            // daLogin
            // 
            this.daLogin.DeleteCommand = this.oleDbDeleteCommand11;
            this.daLogin.InsertCommand = this.oleDbInsertCommand11;
            this.daLogin.SelectCommand = this.oleDbSelectCommand11;
            ...
            this.daLogin.UpdateCommand = this.oleDbUpdateCommand11;
            // 
            // DataController
            // 
        ...
        private System.Data.OleDb.OleDbDataAdapter daLogin;
    }
}